...
public class FileUpload {
	...
	public String upload(MultipartFile mulFile){
		...
		String PATH_ABS = this.getUploadPath()+GlobalConfig.get(Constants.FILE_UPLOAD_PATH);
	...
	public String getRrlUpload(HttpServletRequest request){
		String path = request.getScheme() + "://" + request.getServerName() + ":" + 
	    		request.getServerPort()+GlobalConfig.get(Constants.FILE_UPLOAD_PATH);
	...
	public String proNarrowPic(String oriPicPath){
		...
		try {
			...
			String configPath = GlobalConfig.get(Constants.FILE_UPLOAD_PATH);
