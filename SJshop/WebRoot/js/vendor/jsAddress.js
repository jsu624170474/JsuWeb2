...
var addressInit = function(_province, _city, _area, defaultProvince, defaultCity, defaultArea)
{
	var cmbProvince = document.getElementById(_province);
	var cmbCity = document.getElementById(_city);
	var cmbArea = document.getElementById(_area);
